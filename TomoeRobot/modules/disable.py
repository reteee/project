...
from TomoeRobot.modules.helper_funcs.handlers import CMD_STARTERS, SpamChecker
from TomoeRobot.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from TomoeRobot.modules.sql import disable_sql as sql
