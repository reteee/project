...
from TomoeRobot import pbot as app
from TomoeRobot import arq
from TomoeRobot.services.keyboard import Ikb
from TomoeRobot.utils.pluginhelper import (
    convert_seconds_to_minutes as time_convert,
    fetch,
)
from TomoeRobot.services.tasks import _get_tasks_text, all_tasks, rm_task
from TomoeRobot.services.types import InlineQueryResultCachedDocument
from TomoeRobot.modules.info import get_chat_info, get_user_info
from TomoeRobot.modules.music import download_youtube_audio
from TomoeRobot.utils.functions import test_speedtest
from TomoeRobot.utils.pastebin import paste
